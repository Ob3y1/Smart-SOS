...
Color textColor = index % 2 == 0 ? Colors.black : Colors.black;
Color backcolor = index % 2 == 0 ? Colors.red : Colors.blue; 
Alignment aligR =  index % 2 == 0 ? Alignment.centerRight : Alignment.centerLeft;
                return Column(
                children:[ 
                ClipRRect(
...
*/      alignment :aligR,
      ...
      child:
       ...
       Text(messages[index],style:TextStyle(color:textColor))   )) ,
       SizedBox(height:8)
       ]);
              },
            ),
              ...
              children: [
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(hintText: "اكتب الرسالة هنا.....",
                ...
                IconButton(
                  ...
                  return AlertDialog(title: Text('ادخل مشكلتك في الصندوق من فضلك'),actions:<Widget>[
                  IconButton(
                  icon: Icon(Icons.send),
                  onPressed:(){
      ...
      Container(
      width:double.infinity,
      decoration:BoxDecoration( border:Border.all(color:Colors.transparent,width: 2.0),borderRadius:BorderRadius.circular(10),
      gradient:LinearGradient(colors:
  ...
  Align(
        ...
        child:
                  ...
                  context:context,
                  builder: (BuildContext context){
                  return AlertDialog(title: Text('ارجاء قم يتسجيل الصوت اولا'),actions:<Widget>[
                  IconButton(
                  icon: Icon(Icons.send),
                  onPressed:(){
                  Navigator.of(context).pop();
