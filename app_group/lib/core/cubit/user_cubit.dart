...
import 'package:app_group/core/api/api_consumer.dart';
import 'package:app_group/core/api/end_points.dart';
import 'package:app_group/core/cubit/user_state.dart';
import 'package:app_group/core/errors/exeeptions.dart';
import 'package:app_group/features/group/signup/validate_code.dart';
import 'package:app_group/features/user/UserApp/home1.dart';
import 'package:app_group/features/user/UserApp/lasthome.dart';
import 'package:app_group/features/user/UserApp/model_user.dart';
import 'package:app_group/features/user/UserApp/order.dart';
import 'package:app_group/features/user/UserApp/user_home_model.dart';
import 'package:app_group/features/user/login/login.dart';
import 'package:app_group/features/user/login/model.dart';
  ...
  map(String type, String details, BuildContext context) async {
    ...
    try {
      ...
      if (response.statusCode != null &&
        ...
        getUserHome(response.data["request"]);
