                ...
                <section class=" w-100 overflow-y-auto overflow-x-hidden" data-bs-smooth-scroll="true">
                  <nav class="navbar bg-body-tertiary">
                    <div class="container-fluid  justify-content-md-between">
                      ...
                      <form class="d-flex" role="search" action="{{ route('simple_search') }}" method="GET">
                        @csrf
                  ...
                  @if (session('success'))
                    ...
                    @endif
                    @if (session('error'))
                        <div class="alert alert-danger my-2 mx-2" dir="rtl">
                            {{ session('error') }}
                        </div>
                    @endif
                  <table style="width: 98%;" class=" text-center table table-striped table-bordered mx-auto my-2 w-md-90">
                    <thead>
                      <tr>
                        <th scope="col">ID</th>
      ...
      $('#selectOption').on('change', function () {
          ...
          $(document).ready(function() {
              ...
              $('#staticBackdrop').on('show.bs.modal', function (event) {
                  ...
                  var groupId = button.data('group-id'); // استخراج قيمة group_id

                  // يمكنك الآن استخدام groupId كما تحتاج
                  console.log('Group ID:', groupId);

                  // على سبيل المثال، يمكنك تعيين قيمة group_id في حقل مخفي داخل المودال
