  ...
  <body>
    ...
    <main class="d-flex flex-nowrap">
      ...
      <section class=" w-100 overflow-y-auto" data-bs-smooth-scroll="true">
        ...
        <form class="row g-3 mx-auto  my-2 was-validated" style="width: 98%;" lang="ar" dir="rtl" action="AddGroups" method="POST">
          @csrf
          <div class="col-md-6">
            <label for="inputCity" class="form-label">رقم السيارة</label>
            <div class="input-group" dir="ltr">
                <input type="tel" placeholder="0000000" maxlength="6" minlength="6"
                    class="form-control rounded-end-2" required id="inputcar" pattern="^[0-9]{6}$" name="car_num" value="{{ old('car_num') }}">
            ...
            <div class="col-md-6">
              ...
              <div class="col-md-6 ">
                ...
                <input type="password" required class="form-control" id="inputPassword4"  maxlength="8" pattern="(?=.*\d)(?=.*[a-z]).{4,8}"
                  title="Must contain at least one  number and lowercase letter, and between 4 - 8 characters" name="password" value="{{old('password')}}">
