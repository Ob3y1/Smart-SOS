    ...
    <body>
        ...
        <main class="d-flex flex-nowrap">
            ...
            <section class=" w-100 overflow-y-auto" data-bs-smooth-scroll="true">
                ...
                <form class="row g-3 mx-auto  my-2 was-validated" style="width: 98%;" lang="ar" dir="rtl" method="POST" action="{{ route('postprofile')}}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="date" required class="form-control" id="inputdate4" value="{{$user->date_of_birth}}"
                            min="1970-01-01" name="date_of_birth">
                    ...
                    <div class="col-md-3 mt-5 mb-3 d-block ">
                        <div class="form-check  form-check-inline mx-5 mt-1">
                            <input type="radio" class="form-check-input" id="validationFormCheck2" name="gender" <?php echo ($user->gender == 'male') ? 'checked' : ''; ?>
                                value="male" required>
                        ...
                        <div class="form-check  form-check-inline ms-3">
                            ...
                            <input type="radio" class="form-check-input" id="validationFormCheck3" name="gender" <?php echo ($user->gender == 'female') ? 'checked' : ''; ?>
