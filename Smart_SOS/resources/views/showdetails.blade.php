        ...
        <section class=" w-100 overflow-y-auto" data-bs-smooth-scroll="true">
              <nav class="navbar d-flex bg-body-tertiary justify-content-sm-end justify-content-md-end">
                  <div class="container-fluid  ">
                      <a class="navbar-brand fw-normal fs-4 mb-1 mb-md-0  ">Details Of Groups</a>
                      <div class="d-flex"><a id="link1" href="{{ url('ShowGroups1/' . $group->job_id) }}" class=" me-2 btn btn-outline-primary" data-bs-toggle="tooltip"
                        data-bs-placement="bottom" data-bs-title="pre page"><i class="bi bi-arrow-90deg-left"></i></a>
                    </div>
                    </div>
              </nav>
              
              <nav aria-label="breadcrumb" style="width: 88%;" class="px-2 mt-4  d-flex flex-wrap justify-content-between ">
                ...
                <table style="width: 88%;" class=" text-start  table table-striped table-bordered mt-3 ms-2" >
                  <thead>
                    <tr>
                      <th scope="row">رقم السيارة</th>
                      <td id="num1">{{$group->car_number}}</td>
                    </tr>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td id="updated">{{$group->updated_at}}</td>
                    </tr>
                  </tbody>
                </table>
