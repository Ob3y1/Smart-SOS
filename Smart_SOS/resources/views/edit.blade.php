        ...
        <main class="d-flex flex-nowrap">
            <div id="sidebarId" class="sidebar position-relative d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary ">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <hr style="margin: 5px 15px 5px 5px ; ">
                    <li class="nav-item">
                    <a href="{{route('ShowSites')}}" class="  nav-link link-body-emphasis">
                        <svg class="bi pe-none me-2" width="16" height="16">
            ...
            <section class=" w-100 overflow-y-auto" data-bs-smooth-scroll="true">
                <nav class="navbar d-flex bg-body-tertiary justify-content-sm-end justify-content-md-end">
                    <div class="container-fluid  ">
                        <a class="navbar-brand fw-normal fs-4 mb-1 mb-md-0  ">Edit Groups</a>
                        <div class="d-flex"><a id="link1" href="{{url('ShowGroups1/' . $group->job_id)}}" class=" me-2 btn btn-outline-primary"
                                data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="pre page"><i
                                    class="bi bi-arrow-90deg-left"></i></a>
                        </div>
                    </div>
                </nav>

                <nav aria-label="breadcrumb" style="width: 98%;"
                    class="px-2 mt-4 d-flex flex-wrap justify-content-between ">
                    <ol class="breadcrumb me-2">
                        <li class="breadcrumb-item"><a href="{{url('ShowGroups')}}">Home</a></li>
                        <li class="breadcrumb-item"><a id="link2" href="{{ url('ShowGroups1/' . $group->job_id) }}">{{$group->Job->title}}</a></li>
                        <li class="breadcrumb-item active" aria-current="page" id="num">{{$group->car_number}}</li>
                    </ol>
                    <p><span class="fw-medium fs-6">ID : </span><span id="id"> {{$group->id}}</span></p>
                </nav>


                <form class="row g-3 mx-auto  my-2 " id="myForm" style="width: 98%;" lang="ar" dir="rtl" action="{{ url('updategroup2/' . $group->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="col-md-6">
                        <label for="inputCity" class="form-label">رقم السيارة</label>
                        <div class="input-group" dir="ltr">
                            <input type="tel" placeholder="0000000" maxlength="6" minlength="6"
                                class="form-control rounded-end-2" required id="inputcar" pattern="^[0-9]{6}$" name="car_num" value="{{$group->car_number }}">
                            <div class="invalid-feedback" dir="rtl">
                                رجاءً ادخل رقم صحيح
                            </div>
                        </div>
                        @if ($errors->has('car_num'))
                            <p class="text-danger d-block">{{ $errors->first('car_num') }}</p>
                        @endif
                    </div>
                    <div class="col-md-6">
