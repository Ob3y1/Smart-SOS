    ...
    <main class="d-flex flex-nowrap">
        <div id="sidebarId" class="sidebar position-relative d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary ">
          ...
          <ul class="nav nav-pills flex-column mb-auto">
            ...
            <hr style="margin: 5px 15px 5px 5px ; ">
            <li class="nav-item">
              <a href="{{route('ShowCo')}}" class="active nav-link link-body-emphasis">
                <svg class="bi pe-none me-2" width="16" height="16">
        ...
        <div class="accordion-item">
            ...
            <div id="{{ $collapseId }}" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                <div class="accordion-body g-3" dir="rtl">
                    <strong>انا المواطن </strong><a href="grouprequest"><strong>{{$complaint->User->name}}</strong></a> و لدي الشكوى التالية 
