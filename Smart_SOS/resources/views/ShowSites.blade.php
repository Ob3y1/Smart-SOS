  ...
  <main class="d-flex flex-nowrap">
    ...
    <nav class="navbar bg-body-tertiary">
        <div class="container-fluid justify-content-md-between ">
            <a class="navbar-brand fw-normal fs-4 mb-1 mb-md-0">Sites </a>
        
            <div class="d-flex ">
              <h4 class="fw-normal fs-4 me-2 mt-1">Add Sites</h4><a href="AddSites"
                class=" me-2 btn btn-outline-primary" data-bs-toggle="tooltip" data-bs-placement="bottom"
                data-bs-title="Add Sites" href=""><i class="bi bi-plus-lg"></i></a>
            </div>
          </div>
    </nav>
    @if (session('success'))
                        <div class="alert alert-success my-2 mx-2" dir="rtl">
                            {{ session('success') }}
                        </div>
                    @endif
    <div id="map" ></div>
    <table style="width: 100%;" class="text-center table table-striped table-bordered mx-auto  my-4 w-md-90">
        <thead>
            <tr>
                <th scope="col">ID</th>
        ...
        <tbody id="">
            @foreach ($sites as $group)
                  <tr>
                    <th scope="row"><a href="showsitegroup/{{$group->id}}">{{$group->id}}</a></th>
    ...
    <script>
        // إنشاء الخريطة وتحديد الإحداثيات الأساسية
        var map = L.map('map').setView([33.51148284042907, 36.29510367222407], 12); // تعديل الإحداثيات للموقع الافتراضي
        ...
        // جلب المواقع من الخادم وإضافتها للخريطة
        var sites = @json($sites);
        sites.forEach(function(site) {
            // إضافة العلامات لكل موقع على الخريطة
